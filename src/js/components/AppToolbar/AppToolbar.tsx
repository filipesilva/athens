    ...
    >
      <HStack flex="1">
        <ButtonGroup size="sm" mr="auto">
          ...
          <Tooltip label="Right side comments">
            <ToolbarIconButton
              aria-label="Right side comments"
              isActive={isShowRightSideComments}
              onClick={handleClickRightSideComments}>
              <DailyNotesIcon />
            </ToolbarIconButton>
          </Tooltip>
          <Tooltip label={"Notifications: " + notificationCount}>
            <ToolbarIconButton
